...
import mcdd.cbq.maker.meta.enums.FileGenerateTypeEnum;
import mcdd.cbq.maker.meta.enums.FileTypeEnum;
import mcdd.cbq.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "mcdd.cbq.maker");
